...
const ContactSection = () => {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto text-center pt-16 bg-indigo-50">
        <h1 className="text-indigo-800 text-3xl md:text-4xl font-bold relative inline-block pb-2.5 mb-3">
          Contact Section
      ...
      <section id="contact" className="bg-gradient-to-br bg-indigo-50 pb-40">
