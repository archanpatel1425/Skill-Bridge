...
import skillbridgeImage from '../assets/images/myimg.png'; // Add the correct path to your image file
...
const About = () => {
  ...
  return (
    <div className="pt-20 px-4 md:px-0 bg-indigo-200 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row items-start md:justify-between pt-20">
        {/* Left side with Image and Static Data */}
        <div className="w-full md:w-1/3 flex flex-col justify-center items-center p-4 md:p-6">
          <img
            src={skillbridgeImage}
            alt="Skillbridge"
            className="w-48 h-48 md:w-64 md:h-64 rounded-lg object-cover mb-4"
          />
        ...
        {/* Right side with Full Text Content */}
        <div className="w-full md:w-2/3 md:pl-8 p-4">
